...
-- Test TwitterUser
insert into user (id, email, password, enabled, created) values (1, 'test@email.com', '$2a$10$w.luBxeDvf5aW8Ncxyp90OLnReNW/KhIYcSdgefLrje27USeBRp2C', true, '2008-08-08 00:00:00');
